	...
	main: function (container, depth0, helpers, partials, data) {
		...
		return (
			((stack1 = container.invokePartial(
				lookupProperty(partials, 'attribute'),
				depth0,
				{
					name: 'attribute',
					data: data,
			...
			alias4(
				((helper =
					(helper =
						lookupProperty(helpers, 'strengthModifier') ||
						(depth0 != null
							? lookupProperty(depth0, 'strengthModifier')
							: depth0)) != null
						? helper
						: alias2),
				typeof helper === alias3
					? helper.call(alias1, {
							...
							data: data,
							loc: {
								start: { line: 577, column: 65 },
								end: { line: 577, column: 85 },
							},
					  })
					: helper),
			) +
			...
			alias4(
				((helper =
					(helper =
						lookupProperty(helpers, 'intelligenceModifier') ||
						(depth0 != null
							? lookupProperty(depth0, 'intelligenceModifier')
							: depth0)) != null
						? helper
						: alias2),
				typeof helper === alias3
					? helper.call(alias1, {
							...
							data: data,
							loc: {
								start: { line: 584, column: 69 },
								end: { line: 584, column: 93 },
							},
					  })
					: helper),
			) +
			...
			alias4(
				((helper =
					(helper =
						lookupProperty(helpers, 'wisdomModifier') ||
						(depth0 != null
							? lookupProperty(depth0, 'wisdomModifier')
							: depth0)) != null
						? helper
						: alias2),
				typeof helper === alias3
					? helper.call(alias1, {
							...
							data: data,
							loc: {
								start: { line: 591, column: 63 },
								end: { line: 591, column: 81 },
							},
					  })
					: helper),
			) +
			...
			alias4(
				((helper =
					(helper =
						lookupProperty(helpers, 'dexterityModifier') ||
						(depth0 != null
							? lookupProperty(depth0, 'dexterityModifier')
							: depth0)) != null
						? helper
						: alias2),
				typeof helper === alias3
					? helper.call(alias1, {
							...
							data: data,
							loc: {
								start: { line: 598, column: 66 },
								end: { line: 598, column: 87 },
							},
					  })
					: helper),
			) +
			...
			alias4(
				((helper =
					(helper =
						lookupProperty(helpers, 'constitutionModifier') ||
						(depth0 != null
							? lookupProperty(depth0, 'constitutionModifier')
							: depth0)) != null
						? helper
						: alias2),
				typeof helper === alias3
					? helper.call(alias1, {
							...
							data: data,
							loc: {
								start: { line: 605, column: 69 },
								end: { line: 605, column: 93 },
							},
					  })
					: helper),
			) +
			...
			alias4(
				((helper =
					(helper =
						lookupProperty(helpers, 'charismaModifier') ||
						(depth0 != null
							? lookupProperty(depth0, 'charismaModifier')
							: depth0)) != null
						? helper
						: alias2),
				typeof helper === alias3
					? helper.call(alias1, {
							...
							data: data,
							loc: {
								start: { line: 612, column: 65 },
								end: { line: 612, column: 85 },
							},
					  })
					: helper),
			) +
...
this['System']['templates']['equipment'] = Handlebars.template({
	compiler: [8, '>= 4.3.0'],
	main: function (container, depth0, helpers, partials, data) {
...
this['System']['templates']['npc'] = Handlebars.template({
	compiler: [8, '>= 4.3.0'],
	main: function (container, depth0, helpers, partials, data) {
...
this['System']['templates']['spell'] = Handlebars.template({
	compiler: [8, '>= 4.3.0'],
	main: function (container, depth0, helpers, partials, data) {
		return "<p>\n  <label for='name'>Name:</label>\n  <input name='name' />\n</p>\n\n<p>\n  <label for='description'>Description:</label>\n  <input name='description' />\n</p>"
	},
...
this['System']['templates']['weapon'] = Handlebars.template({
	compiler: [8, '>= 4.3.0'],
	main: function (container, depth0, helpers, partials, data) {
		return "<script>\n  function drag(e) { const { type, id } = e.target.dataset\n  e.dataTransfer.setData(type, id) }\n</script>\n\n<p>\n  <label for='name'>Name:</label>\n  <input name='name' />\n</p>\n\n<p>\n  <label for='weight'>Weight:</label>\n  <input name='weight' />\n</p>"
	},
...
this['System']['templates']['attribute'] = Handlebars.template({
	compiler: [8, '>= 4.3.0'],
	main: function (container, depth0, helpers, partials, data) {
		return "This is 'attribute partial'"
	},
	useData: true,
})
